...
export default function ApiKeysPage() {
  ...
  async function loadApiKeys() {
    try {
      ...
      // API returns array directly or object with apiKeys property
      const keysData = Array.isArray(data) ? data : data.apiKeys || [];
      setApiKeys(keysData.map((key: any) => ({
        id: key.id,
        name: key.name,
        provider: key.provider,
        preview: key.encryptedValue ? `${key.encryptedValue.substring(0, 20)}...` : 'N/A',
